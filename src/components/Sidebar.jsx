...
export default function Sidebar({ open, onClose }) {
  ...
  const dashboardHref =
    normalizedRole === "peer_counsellor"
  ...
  if (normalizedRole === "dean") {
    ...
    navItems = [
      ...
      {
        href: "/staff/peer/follow-up-notes",
        label: "Follow-Up Notes",
        icon: "fas fa-sticky-note",
      },
      {
        href: "/staff/peer/high-risk-alerts",
    ...
    navItems = [
      ...
      {
        href: "/staff/sumc/create-referral",
        label: "Create Referral",
        icon: "fas fa-plus",
      },
      {
        href: "/staff/sumc/schedule-sessions",
        label: "Schedule Sessions",
        icon: "fas fa-calendar-check",
      },
      {
        href: "/staff/sumc/add-resources",
        label: "Add Resources",
