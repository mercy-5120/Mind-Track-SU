...
export default function PeerDashboard() {
  ...
  const stats = [
    ...
    { id: 4, title: 'Resources', icon: 'fas fa-book', value: resources.length.toString() },
  ];

  const handleStatClick = (index) => {
    const routes = ['/staff/peer/dashboard', '/staff/peer/schedule-sessions', '/staff/peer/referrals', '/staff/peer/resources'];
      ...
      <section className={styles.chartSection}>
        ...
        <div className={styles.quickActions}>
          ...
          <div className={styles.sumcOnly}>
            <button className={buttonStyles.btnPrimary} onClick={() => navigate('/staff/peer/schedule-sessions')}><i className="fas fa-calendar-check"></i> Record Follow-up</button>
            <button className={buttonStyles.btnSecondary} onClick={() => navigate('/staff/peer/referrals')}><i className="fas fa-user-md"></i> Manage Referral</button>
            <button className={buttonStyles.btnSecondary} onClick={() => navigate('/staff/peer/resources')}><i className="fas fa-book"></i> Open Resources</button>
          </div>
        </div>
      </section>
    </Layout>
